...
import { registProcess } from "../utils/api";
...
const registActive = async () => {
  if (regist.password !== regist.checkPassword) {
    alert("密碼重複時有錯誤，請重新輸入");
    regist.password = "";
    regist.checkPassword = "";
    return;
  }
  await registProcess(regist.account, regist.password, regist.username);
};
</script>
  ...
  <div class="overflow-hidden p-5 pt-8">
    ...
    >
      ...
      <div class="flex flex-col items-center justify-center gap-6">
        <SakuraButton>建立帳號</SakuraButton>
