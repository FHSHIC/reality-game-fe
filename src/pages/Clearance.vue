...
import { teamStatus } from "../utils/status";
import { finishGame } from "../utils/api";
</script>

<template>
  <div class="bg-Clear h-screen w-screen bg-cover bg-center bg-no-repeat">
    <div class="flex justify-center">
      <img :src="title" alt="" class="mt-[50px] mb-4 w-[270px]" />
    </div>
    <div class="flex justify-center">
        ...
        <div class="absolute top-[500px]">
          <router-link to="/">
            <Botton
              ...
              @click="finishGame(teamStatus.data.gamecode)"
            />
          </router-link>
        </div>
      </div>
